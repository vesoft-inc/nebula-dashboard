...
export const MetricPopover = (props: { list }) => {
  ...
  const manualHref =
    locale === 'ZH_CN'
      ? 'https://docs.nebula-graph.com.cn/3.1.0/nebula-dashboard/6.monitor-parameter/'
      : 'https://docs.nebula-graph.io/3.1.0/nebula-dashboard/6.monitor-parameter/'; // TODO update english docs link
